	...
	export default {
        ...
        computed: {
            ...
            page: {
                ...
                set(val) {
		            return this.$store.commit('courier/SET_PAGE', val)
                }
            }
        },
        ...
        watch: {
            ...
            search() {
                this.getCouriers(this.page) //MAKA FUNGSI INI DIJALANKAN
            }
        },

        methods: {
		    ...mapActions('courier', ['getCouriers', 'removeCourier']), //MENGAMBIL METHOD DARI STORE COURIER
