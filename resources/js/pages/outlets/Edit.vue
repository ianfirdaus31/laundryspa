...
<script>
	...
	export default {
        ...
        created() {
            //SEBELUM COMPONENT DI-RENDER KITA MELAKUKAN REQUEST KE SERVER BERDASARKAN CODE YANG ADA DI URL
        ...
        methods: {
            ...
            submit() {
                //KETIKA TOMBOL UPDATE DI MAKA AKAN MENGIRIMKAN PERMINTAAN UNTUK MENGUBAH DATA BERDASARKAN CODE YANG DIKIRIMKAN
                this.updateOutlet(this.$route.params.id)
                    .then(() => {
                        //APABILA BERHASIL MAKA AKAN DI-DIRECT KEMBALI KE HALAMAN /outlets
