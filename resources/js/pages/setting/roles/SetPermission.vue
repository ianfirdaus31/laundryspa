	...
	export default {
        ...
        computed: {
            ...
            ...mapState('user', {
                ...
                permissions: state => state.permissions, //ME-LOAD STATE PERMISSIONS
                role_permission: state => state.role_permission, //STATE YANG MENAMPUNG PERMISSION YG TELAH DI-ASSIGN
            })
        },
        ...
        methods: {
            ...
            ...mapActions('user', [
                'getUserLists', 'getRoles', 'getAllPermission', 'getRolePermission', 'setRolePermission', 'setRoleUser'
            ]),
            ...
            addPermission(name) {
                ...
                //JIKA TIDAK TERSEDIA, INDEXNYA -1
                if (index === -1) {
